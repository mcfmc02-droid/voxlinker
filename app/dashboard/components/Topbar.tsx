...
export default function Topbar() {
  ...
  return (
    <header className="h-16 flex items-center justify-end px-8 border-b border-gray-100 bg-white">
      ...
      <div className="flex items-center gap-6 relative">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {open && (
            <div className="absolute right-0 mt-3 w-64 bg-white shadow-xl rounded-xl border border-gray-100 overflow-hidden">
